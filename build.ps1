<#
.SYNOPSIS
    A CUstom BuildScript For The Module CipherTron
.DESCRIPTION
...
"@
    ...
    function Set-BuildVariables {
        ...
        Process {
            ...
            if ($null -eq $Version) { throw [System.ArgumentNullException]::new('version', "Please make sure localizedData.ModuleVersion was loaded.") }
